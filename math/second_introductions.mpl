...
E_TMRCA := int(1-cdf1_simp, t=0..T1) + int(1-cdf2_simp, t=T1..T2) + int(1-cdf3_simp, t=T2..infinity);
E_TMRCA_simplified := simplify(E_TMRCA) assuming t>0, T1>0, Nec>0, Nea>0, Nef>0, T2>0, T2 > T1;
Python(E_TMRCA_simplified);
cg1 = (32 * (m * Nec + 0.1e1 / 0.2e1) * (m * Nec + 0.1e1 / 0.4e1) * (Nef * (Nea + Nef) * m + Nea / 2 - Nef / 2) * math.exp(((-4 * Nef * T2 * m + T1 - T2) * Nec - Nef * T1) / Nec / Nef / 2) + 64 * (m * Nec + 0.1e1 / 0.4e1) * (m * Nef + 0.1e1 / 0.4e1) * (-Nef + Nec) * math.exp((-2 * m * (T1 + T2) * Nec - T1) / Nec / 2) + 128 * (m * Nef + 0.1e1 / 0.2e1) * (-(m * Nec + 0.1e1 / 0.2e1) * (-Nef + Nec) * (Nea * m + 0.3e1 / 0.4e1) * math.exp(-T1 * (4 * m * Nec + 1) / Nec / 2) / 4 + ((-m * Nec - 0.1e1 / 0.4e1) * math.exp(-T2 * m) + (m * Nec + 0.1e1 / 0.2e1) * (Nea * m + 0.3e1 / 0.4e1)) * (m * Nef + 0.1e1 / 0.4e1) * Nec)) / (4 * m * Nec + 1) / (2 * m * Nef + 1) / (4 * m * Nef + 1) / (2 * m * Nec + 1)
