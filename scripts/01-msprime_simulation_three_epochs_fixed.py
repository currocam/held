...
def analysis(Ne1, Ne2, Ne3, t1, t2):
    demo = msprime.Demography.isolated_model([Ne1])
    demo.add_population_parameters_change(initial_size=Ne2, time=t1)
    demo.add_population_parameters_change(initial_size=Ne3, time=t2)
    ...
    data["predictions"] = held.expected_ld_piecewise_constant(
        Ne_values=[Ne1, Ne2, Ne3],
        t_boundaries=[t1, t2],
