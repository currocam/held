...
def analysis(Ne_c, Ne_a, alpha, t0, t1):
    demo = msprime.Demography.isolated_model([Ne_c])
    demo.add_population_parameters_change(initial_size=Ne_c, growth_rate=alpha, time=t0)
    demo.add_population_parameters_change(initial_size=Ne_a, growth_rate=0, time=t1)
    ...
    data["predictions"] = held.expected_ld_exponential_carrying_capacity(
        Ne_c=Ne_c,
        Ne_a=Ne_a,
        alpha=alpha,
        t0=t0,
